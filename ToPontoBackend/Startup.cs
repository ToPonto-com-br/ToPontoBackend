...
using ToPontoBackend.CrossCutting.IoC;
using ToPontoBackend.CrossCutting.Assemblies;

namespace ToPontoBackend.Api;
...
public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/ToPonto-api/swagger/v1/swagger.json", "ToPonto-api v1");
        });
        // }
